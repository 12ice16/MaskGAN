...
from build_model.utils import TryExcept, emojis
from build_model.utils.downloads import curl_download, gsutil_getsize
from build_model.utils.metrics import box_iou, fitness
...
def check_requirements(requirements=ROOT / 'requirements.txt', exclude=(), install=True, cmds=''):
    ...
    if s and install and AUTOINSTALL:  # check environment variable
        LOGGER.info(f"{prefix} requirement{'s' * (n > 1)} {s}not found, attempting AutoUpdate...")
